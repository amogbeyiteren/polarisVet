...
export const services = [
  ...
  { title: "Pet Wellness Exams", description: "Regular checkups to monitor and maintain your pets health.", color: "bg-violet-600" , img: serviceImage2  },
  ...
  { title: "Pain Management", description: "Comprehensive solutions for managing your pets pain.", color: "bg-orange-600", img: serviceImage4 },
  { title: "Cosmetic Surgery", description: "At Polaris Veterinary Consult, we offer various pet cosmetic surgeries to enhance the appearance and well being of your pet.Our experienced veterinanians are dedicated to providing safe and humane procedures<br>Tail Docking<br>Tail docking is a surgical procedure that involves removing a portion f a dogs tail.While some breeds traditionally have their tails docked for cosmetic reasons.It's essential to consider the potential risks and benefits before making a decision.<br>Benefits of tail Docking<br>Reduced risk of tail injury<br>Enhanved appearance for certain breeds<br>Risks of Tail Docking<br>pain and dicomfort<br> infections and complications<br>Potetial impact on communiction and balance<br>Ear cropping<br>Ear cropping is a surgical procedure thta involves reshaping or removing a portion of a dog's ears.Like tail docking,er cropping is often performed for cosmetic reasons,but its crucial to weigh the potential risks and benefits", color: "bg-indigo-600", img: serviceImage5   },
  {title:"Bovine services", description:"A preventative herd health plan will include herd or individual exams,vaccines, pregnancy checks,castrations,and a deworming program.During their lives,cattle develop two types of immunity:paassive imunity and active immunity. Passive immunity is passed dow from a cow to her calf in colostrum.Active immunity is developed as the rsult of good immuniztion program or exposure to a disease.A good health program begins in the cow which allows her to pass the immunity on to her calf",color:"bg black-600",img:horses.jpg},
  { title:"Caprine and ovine Services",description:"A good preventative herd health program for goats and sheep will include exams, vaccines,deworming program,and recommended food/nutrition program.<br> At Polaris Veterinary Consult,we offer disbudding and dehrning services.Dehorning is the removal of the horn in order to reduce potential injury to other animals or people.If this procedure is performed under two months of age,before the hornshave fully attached to the skull,it is termed disbudding<br>Over grown hooves can make walking diffivult or even painful.Animals with overgrown hooves may develop arthritis which causes them to be susceptible to joint and tendon problems.Hoof trimming is recommended about every two months for both sheep and goats", color: "bg-orange-600",img:horses.jpg},
];
