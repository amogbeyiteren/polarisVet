...
export const services = [
  ...
  { title: "General Surgery", description: "Expert surgical care to ensure your pets well-being.", color: "bg-purple-600", img:generalsurgery},
  ...
  { title: "Pet Euthanasia", description: "Compassionate end-of-life care for your pets.", color: "bg-gray-600", img: blackdog },
  ...
  {title:"Bovine services", description:"A preventative herd health plan will include herd or individual exams,vaccines, pregnancy checks,castrations,and a deworming program.During their lives,cattle develop two types of immunity:paassive imunity and active immunity. Passive immunity is passed dow from a cow to her calf in colostrum.Active immunity is developed as the rsult of good immuniztion program or exposure to a disease.A good health program begins in the cow which allows her to pass the immunity on to her calf",color:"bg black-600",img:bovine},
